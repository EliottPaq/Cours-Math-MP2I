\chapter{Inégalité et fonction (rappels et compléments)}
...
\begin{defprop}[opération sur les fonctions dérivables]
...
\end{dem}
\begin{defprop}[Trois fonctions usuelles trigonométriques]
	\begin{itemize}
